---
title: "An introduction to the `causalGBN` package"
output:
  rmarkdown::html_vignette:
    number_sections: true
vignette: >
  %\VignetteIndexEntry{using_causalGBN}
